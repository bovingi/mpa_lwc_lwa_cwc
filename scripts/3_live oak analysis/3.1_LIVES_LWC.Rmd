...
combined_slopes_wide <- cowplot::plot_grid(hyd_slopes , NULL, time_summary, NULL,space_slope, #comment out the #_bs if want to use se  
                                           # NULL, pv_slope,
                                   nrow = 1, 
...
ggsave(here("figures", "quag figures", "LWC", "combined_plots_all_quag_new"), combined_plots_all, device = "jpg", width = 12, height = 7, dpi = 300)
```
#------------------------------------
####SWC and LMA: 
