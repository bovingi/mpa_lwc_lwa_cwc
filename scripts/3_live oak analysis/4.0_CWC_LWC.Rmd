...
#LWA data: 
data_og_lwc  <- read_csv(here::here("processed-data", paste0("analysis_bothspp",datver,".csv")), show_col_types = FALSE) %>% 
...
ggsave(here("figures", "quag figures", "CWC", "combined_plots_lwc_quag_bs"), combined_plots_all_legend, device = "jpg", width = 10, height = 7, dpi = 300)
```
