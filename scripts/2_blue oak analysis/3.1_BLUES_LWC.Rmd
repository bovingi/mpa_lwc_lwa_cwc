...
#   distinct() 
# 
# read_csv(here::here("processed-data", paste0("analysis",datver,".csv")), show_col_types = FALSE) %>% 
...
```{r, warning = F, echo=FALSE}
#scaled
space_nice_centered <- wc_qudo_df_space %>% 
  #drop_na(site) %>% 
  ggplot(aes(y = water_potential, 
             x = lwc_mean_centered, 
            #x = lwc_mean,
...
ggsave(here("figures", "quag figures", "LWC", "lma_mpa_plot.jpg"), lma_mpa_plot, device = "jpg", width = 6, height = 4, dpi = 600)
```
