...
#####Whole time period after leaf expansion (April 25, May 04, May 09, May 23)
...
for (variable in variables) {
  ...
  grouping_vars <- if (variable == "lma_g_cm2") c("date_new") else c("date_new", "time")
  
  # Process the data and run the models
  results <- dcwc_allanalyses %>%
...
dcwc_allanalyses0 <- bind_rows(dcwc_allanalyses %>% 
  mutate(time_means = case_when(
    date_new %in% c("2022-04-29", "2022-05-11", "2022-05-29", "2022-07-19") ~ "April 29-July 19",
  ...
  dcwc_allanalyses %>% 
  mutate(time_means = case_when(
    date_new %in% c("2022-03-08", "2022-03-16", "2022-03-22", "2022-04-05", "2022-04-12", "2022-04-29") ~ "March 8-April 29",
    #month %in% c("2022-04-29", "2022-05-11", "2022-05-29") ~ "April 29-May 29",
   # month %in% c("2022-04-29", "2022-05-11", "2022-05-29", "2022-07-19") ~ "April 29-July 19",
    TRUE ~ as.character("Other dates")
  )),
