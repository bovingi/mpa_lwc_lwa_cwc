...
# Save plot
#ggsave(here::here("figures", "qudo figures", "dCWC", "dcwc_mpa_alldates_SI.jpg"), plot = mpa_plot, width = 10, height = 5)
```
...
# Save plot
#ggsave(here::here("figures", "qudo figures", "dCWC", "dcwc_SI.jpg"), plot = final_plot, width = 8, height = 8)
```
...
#ggsave(here::here("figures", "qudo figures", "dCWC", "means_plot_SI.jpg"), plot = means_plot, width = 6.5, height = 8)
...
# Save plot
#ggsave(here::here("figures", "qudo figures", "dCWC", "dcwc_SI.jpg"), plot = final_plot, width = 8, height = 8, dpi = 600)
```
...
dcwc_mpa_plot <- fig_data1 %>%
  ...
  theme(legend.position = c(0.9, 0.15), 
    ...
    #      analysis == "dcwc_alldata"),
    aes(label = "D"),
    x = -Inf, y = Inf, hjust = -0.5, vjust = 1.5, size = 6, fontface = "bold",
    inherit.aes = FALSE
  ) 
...
# Save plot
#ggsave(here::here("figures", "qudo figures", "dCWC", "dcwc_combinespp_SI.jpg"), plot = final_plot, width = 6.5, height = 8, dpi = 600)
```
